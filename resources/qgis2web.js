...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-6.162057, 9.772667, 2.383588, 15.723823], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-5.511255, 9.415337, 2.407427, 15.083105],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-6.162057, 9.772667, 2.383588, 15.723823], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DECOUPAGE_DU_BURKINA</h2>';
        return titleElement;
    })(),
