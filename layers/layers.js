...
//ol.proj.get("EPSG:4326").setExtent([-6.162057, 9.772667, 2.383588, 15.723823]);
var wms_layers = [];
...
lyr_mapping_centroides_1.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'no label', 'Nom': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
